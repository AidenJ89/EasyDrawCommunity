...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个AIGC,我是一个干饭人部署的,欢迎来到AI世界探索🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'EasyDraw', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一有底蕴的AI社区🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://easydraw.ac.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, AI绘画', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zhiweijiang1206@easydraw.ac.cn', // 邮箱地址 例如mail@tangly1024.com
  ...
  // ----> 站点统计
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // vercel自带的统计 https://vercel.com/docs/concepts/analytics/quickstart
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'luj8mzz2dn', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '易绘AI社区', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个有底蕴的AI社区', // 站点描述，被notion中的页面描述覆盖
